    ...
    treePolicy(node){
        ...
        return current;
            ...
            defaultScenario (current) {
                ...
                board.side=side;
                return this.maximizingPlayer == board.side && board.winner != null ? 1 : -1;
            }
